...
θ1 = @lift(atan($x,$y)-atan($L1*sin($θ2)/($L1+$L2*cos($θ2))))

Axis(f[1,1], limits=(-4,4,-4,4))

lines!(@lift([Point2(0,0),Point2($L1*sin($θ1), $L1*cos($θ1)),Point2($L1*sin($θ1)+$L2*sin($θ1+$θ2), $L1*cos($θ1)+$L2*cos($θ1+$θ2))]))
